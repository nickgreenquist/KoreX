...
/*
  ...
  */
  ...
  Serial.print("-");
  Serial.print(mux0array[3]);
  Serial.print("-");
  Serial.print(mux0array[5]);
  Serial.print("-");
  Serial.print(mux0array[7]);
  Serial.print("-");
  Serial.print(mux0array[9]);
  Serial.print("-");
  Serial.print(mux0array[11]);
  Serial.print("-");
  Serial.print(0);
  Serial.print("-");
  Serial.print(mux0array[15]);
  Serial.print("-");
  Serial.print(mux1array[1]);
  Serial.print("-");
  Serial.print(mux1array[3]);
  Serial.print("-");
  Serial.print(mux1array[15]);
  Serial.print("-");
  Serial.print(mux1array[13]);
  Serial.print("-");
  Serial.print(mux1array[11]);
  Serial.print("-");
  Serial.print(mux2array[15]);
  Serial.print("-");
  Serial.print(mux2array[0]);
  Serial.print("-");
  Serial.print(mux1array[5]);
  //Serial.print("-");
  Serial.println(); //line feed
  delay(200);
